            ...
            echo '<tr>
                  ...
                  <td>
                    ...
                    <div class="btn-group">
                      ...
                      <button class="btn btn-danger btnEliminarCliente" idCliente="' . $value["id_c"] . '"><i class="fa fa-times"></i></button>
          ...
          <div class="box-body">
            ...
            <div class="form-group formulario__grupo" id="grupo__inter">
              <div class="input-group">
                ...
                <abbr id="toltipx" title="Ingrese numero interior del domicilio">
                  <div class="formulario__grupo-input">
                    <input type="number" class="form-control input-lg " name="editarInter" id="editarInter" value="" required required onkeyup="mayus(this);">
            ...
            <div class="form-group formulario__grupo" id="grupo__exter">
              <div class="input-group">
                ...
                <abbr id="toltipx" title="Ingrese numero exterior del domicilio">
                  <div class="formulario__grupo-input">
                    <input type="number" class="form-control input-lg " name="editarExter" id="editarExter" value="" required required onkeyup="mayus(this);">
